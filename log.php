...
//set Pager refresh Time in Seconds
header("refresh: 30;");

//define('LOG_PATH','/var/log');
define('LOG_PATH', '/mnt/CitrixLogs/Users/Tina.Hoferichter/AppData/Local/Application Data/Citrix/Receiver');
...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/pure-min.css">
...
<!--         
	<form name="LogPath" action=log.php method=get>
        <label for="LogPath">Please enter Path to Logfile: </label><input type="text" name="LogPath">
...
<footer>
<p class="credits"><a href="//pixeline.be">Original Script by pixeline</a>, thanks to <a href="//purecss.io/">purecss.io</a><br><a href="//weiner-online.net"><b><font color='red'>Modified by Florian Weiner 2018</font></b></a></p>
</footer>
</div>
    </div>
</div>
